...
var Reporter = function(e) {
    ...
    function u() { ! v || v.length <= 0 || (r("systemLog", {
            dataArray: v
        }), v = [])
    }
    function c(e) {
...
wx = function(e) {
    ...
    function r(e) {
        if ("[object Error]" === Object.prototype.toString.apply(e)) {
            ...
            S ? console.error(e.stack) : console.error(e.message),
    ...
    A = [],
    P = [];
    "devtools" === (0, p.getPlatform)() && (0, s.subscribe)("SPECIAL_PAGE_EVENT",
    function(e) {
        var t = e.data,
        n = e.eventName,
    ...
    var T = {
        ...
        showNavigationBarLoading: function(e) { (0, s.invokeMethod)("showNavigationBarLoading", e)
        },
        hideNavigationBarLoading: function(e) { (0, s.invokeMethod)("hideNavigationBarLoading", e)
        },
        stopPullDownRefresh: function(e) { (0, s.invokeMethod)("stopPullDownRefresh", e)
        },
        ...
        navigateTo: function(e) {
            u("navigateTo", e, {
                ...
                afterSuccess: function() {
                    v = e.url,
                    (0, d.notifyCurrentRoutetoContext)(v)
                }
            }))
        },
        navigateBack: function(e) { (0, s.invokeMethod)("navigateBack", e)
        },
        getStorage: function(e) {
            u("getStorage", e, {
                ...
                beforeSuccess: function(e) {
                    e.data = (0, p.stringToAnyType)(e.data, e.dataType),
                    delete e.dataType
                }
            })
        },
        ...
        setStorage: function(e) {
            if (u("setStorage", e, {
                ...
                n = t.data,
                o = t.dataType; (0, s.invokeMethod)("setStorage", {
                    key: e.key,
                    data: n,
                    dataType: o,
                    success: e.success,
        ...
        setStorageSync: function(e) {
            ...
            r = o.data,
            i = o.dataType; (0, s.invokeMethod)(n, {
                key: e,
                data: r,
                dataType: i
            })
        },
        clearStorage: function(e) { (0, s.invokeMethod)("clearStorage", e)
        },
        ...
        request: function() {
            ...
            if (u("request", e, {
                ...
                i = "string" != typeof e.data ? o["content-type"].indexOf("application/x-www-form-urlencoded") > -1 ? (0, p.urlEncodeFormData)(e.data) : o["content-type"].indexOf("application/json") > -1 ? JSON.stringify(e.data) : "object" === c(e.data) ? JSON.stringify(e.data) : i.toString() : e.data,
                "GET" === r.toUpperCase() && (e.url = (0, p.addQueryStringToUrl)(e.url, e.data)),
                (0, s.invokeMethod)("request", {
                    url: e.url,
                    data: i,
                    header: o,
                    method: r,
        ...
        closeSocket: function(e) { (0, s.invokeMethod)("closeSocket", e)
        },
        ...
        onSocketOpen: function(e) {
            u("onSocketOpen", e,
            function() {}) && (0, s.onMethod)("onSocketOpen", e)
        },
        onSocketClose: function(e) {
            u("onSocketClose", e,
            function() {}) && (0, s.onMethod)("onSocketClose", e)
        },
        onSocketMessage: function(e) {
            u("onSocketMessage", e,
            function() {}) && (0, s.onMethod)("onSocketMessage", e)
        },
        onSocketError: function(e) {
            u("onSocketError", e,
            function() {}) && (0, s.onMethod)("onSocketError", e)
        },
        ...
        chooseImage: function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {}: arguments[0]; (0, s.invokeMethod)("chooseImage", (0, p.assign)({
                count: 9,
        ...
        startRecord: function(e) { (0, s.invokeMethod)("startRecord", e)
        },
        stopRecord: function(e) { (0, s.invokeMethod)("stopRecord", e)
        },
        ...
        pauseVoice: function(e) { (0, s.invokeMethod)("pauseVoice", e)
        },
        stopVoice: function(e) { (0, s.invokeMethod)("stopVoice", e)
        },
        onVoicePlayEnd: function(e) { (0, s.onMethod)("onVoicePlayEnd", e)
        },
        chooseVideo: function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {}: arguments[0];
            e.sourceType = e.sourceType || ["album", "camera"],
            e.camera = e.camera || ["front", "back"],
            (0, s.invokeMethod)("chooseVideo", e)
        },
        getLocation: function(e) { (0, s.invokeMethod)("getLocation", e)
        },
        openLocation: function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {}: arguments[0];
            u("openLocation", e, {}) && (0, s.invokeMethod)("openLocation", e)
        },
        getNetworkType: function(e) { (0, s.invokeMethod)("getNetworkType", e)
        },
        getSystemInfo: function(e) { (0, s.invokeMethod)("getSystemInfo", e)
        },
        ...
        reportAction: function(e) { (0, s.invokeMethod)("reportAction", e)
        },
        getBackgroundAudioPlayerState: function(e) { (0, s.invokeMethod)("getMusicPlayerState", e)
        },
        playBackgroundAudio: function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {}: arguments[0]; (0, s.invokeMethod)("operateMusicPlayer", (0, p.assign)({
                operationType: "play"
            },
            e), {
        ...
        onBackgroundAudioPlay: function(e) { (0, s.onMethod)("onMusicPlay", e)
        },
        onBackgroundAudioPause: function(e) { (0, s.onMethod)("onMusicPause", e)
        },
        onBackgroundAudioStop: function(e) { (0, s.onMethod)("onMusicEnd", e)
        },
        login: function(e) { (0, s.invokeMethod)("login", e)
        },
        checkLogin: function(e) { (0, s.invokeMethod)("checkLogin", e)
        },
        authorize: function(e) { (0, s.invokeMethod)("authorize", e)
        },
        getUserInfo: function(e) { (0, s.invokeMethod)("operateWXData", (0, p.assign)({
                data: {
            ...
            e), {
                ...
                beforeSuccess: function(e) {
                    "android" === (0, p.getPlatform)() && (e.data = JSON.parse(e.data)),
        ...
        getFriends: function(e) { (0, s.invokeMethod)("operateWXData", {
                data: {
        ...
        requestPayment: function(e) { (0, s.invokeMethod)("requestPayment", e)
        },
        verifyPaymentPassword: function(e) { (0, s.invokeMethod)("verifyPaymentPassword", e)
        },
        bindPaymentCard: function(e) { (0, s.invokeMethod)("bindPaymentCard", e)
        },
        openAddress: function(e) { (0, s.invokeMethod)("openAddress", e)
        },
        saveFile: function(e) { (0, s.invokeMethod)("saveFile", e)
        },
        openDocument: function(e) { (0, s.invokeMethod)("openDocument", e)
        },
        chooseContact: function(e) { (0, s.invokeMethod)("chooseContact", e)
        },
        makePhoneCall: function(e) { (0, s.invokeMethod)("makePhoneCall", e)
        },
        ...
        onAppEnterBackground: function(e, t) { (0, s.onMethod)("onAppEnterBackground",
            function() {
                "function" == typeof e && e.apply(e, arguments),
                Reporter.submit()
            })
        },
        onAppEnterForeground: function(e, t) { (0, s.onMethod)("onAppEnterForeground", e)
        },
        setAppData: function(e) {
            ...
            function() {
                ...
                i = function(e, t, n) {
                    o = !0,
                    r[e] = t,
                    "Array" === n || "Object" === n ? g[e] = JSON.parse(JSON.stringify(t)) : g[e] = t
                };
                for (var a in e) {
                    var u = e[a],
                    c = g[a],
        ...
        createAnimation: function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {}: arguments[0];
            if (u("createAnimation", e, {})) return new l.
        default(e)
        },
        onWebviewEvent: function(e, t) {
            b = e,
            (0, s.subscribe)("PAGE_EVENT",
            function(t) {
                var n = t.data,
                o = t.eventName,
    ...
    }; (0, s.subscribe)("pageReady",
    function() { (0, s.publish)("pageInitData", {
            data: g
        })
    }),
    ...
    (0, s.onMethod)("onAppRoute", i(function(e) {
        ...
        "navigateBack" != e.openType && "redirectTo" != e.openType || (0, h.clearOldWebviewCanvas)(),
        (0, h.notifyWebviewIdtoCanvas)(e.webviewId),
    ...
    ["onCanvasTouchStart", "onCanvasTouchMove", "onCanvasTouchEnd", "onCanvasTouchCancel"].forEach(function(e) { (0, s.onMethod)(e, i(function(t) {
...
function(e, t) {
    ...
    function a(e) {
        ...
        function(t) {
            ...
            n ? ("function" == typeof o.beforeSuccess && o.beforeSuccess(t), "function" == typeof r.success && r.success(t), "function" == typeof o.afterSuccess && o.afterSuccess(t)) : i ? ("function" == typeof r.cancel && r.cancel(t), "function" == typeof o.cancel && o.cancel(t), Reporter.reportIDKey({
                key: e + "_cancel"
...
function(e, t) {
    ...
    var w = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
    function(e) {
        return typeof e
    }: function(e) {
        return e && "function" == typeof Symbol && e.constructor === Symbol ? "symbol": typeof e
...
function(e, t, n) {
    ...
    [].concat(f, l).forEach(function(e) {
        "fill" == e || "stroke" == e ? u.prototype[e] = function() {
            ...
            r(i) && r(a) && r(k) && r(j) ? data = [t, n, o, i, a, k, j, l, m] : r(i) && r(a) ? data = [t, n, o, i, a] : data = [t, n, o],
            this.actions.push({
                method: e,
                data: data
            })
...
function(e, t, n) {
    ...
    function r() {
        console.log(h);
        for (var e in h) if (0 == e.indexOf(d + "canvas")) {
            h[e];
            delete h[e]
        }
    }
    ...
    function c(e) {
        if (e.canvasId) {
            ...
            if ("number" == typeof h[t]) e.canvasId = h[t],
            (0, p.invokeMethod)("toTempFilePath", e);
            else {
                var n = {
    ...
    function(e, t) {
        ...
        i = o(d, n);
        h[i] = h[i] || r,
        Array.isArray(g[i]) && (g[i].forEach(function(e) {
...
function(e, t, n) {
    ...
    t.pageHolder = function(e) {
        if (!__wxRouteBegin) throw (0, u.error)("Page注册错误", "不要在 " + __wxRoute + ".js 注册多个Page"),
        new r.AppServiceEngineKnownError("Please do not register multiple Page in " + __wxRoute + ".js");
        __wxRouteBegin = !1;
        var t = __wxConfig.pages,
        n = t[l];
        if (n !== __wxRoute) {
            var o = t[l];
            throw (0, u.error)("Page注册错误", "没有在 " + o + ".js 找到Page"),
            new r.AppServiceEngineKnownError("Please register Page in " + o + ".js")
        }
        if (l++, "Object" !== (0, u.getDataType)(e)) throw (0, u.error)("Page注册错误", __wxRoute + ".js中Page()的参数不是对象: " + JSON.stringify(e)),
        new r.AppServiceEngineKnownError("Options is not object: " + JSON.stringify(e) + " in " + __wxRoute + ".js"); (0, u.info)("Register Page: " + n),
        f[n] = e
    },
    function(e, t, n) {
        var o = void 0;
        f.hasOwnProperty(e) ? o = f[e] : ((0, u.warn)("Page[" + e + "] not found. May be caused by: 1. Forgot to add page route in app.json. 2. Invoking Page() in async task."), o = {}),
        d.newPageTime = Date.now();
        var r = new a.
    default(o, t, e); (0, u.isDevTools)() && (__wxAppData[e] = r.data, __wxAppData[e].__webviewId__ = t, (0, u.publish)(c.UPDATE_APP_DATA)),
        s = {
            page: r,
            webviewId: t,
            route: e
    ...
    y = function(e) {
        e.page.onUnload(),
        (0, u.isDevTools)() && (delete __wxAppData[e.route], (0, u.publish)(c.UPDATE_APP_DATA)),
        delete p[e.webviewId]
    },
    w = function(e, t, n, o) {
        if ((0, u.info)("On app route: " + e), d.appRouteTime = Date.now(), "navigateTo" === o) s && v(s),
        p.hasOwnProperty(t) ? (0, u.error)("Page route错误", "navigateTo 一个已经存在的webviewId" + t) : g(e, t, n);
        else if ("redirectTo" === o) s && y(s),
        p.hasOwnProperty(t) ? (0, u.error)("Page route错误", "redirectTo 一个已经存在的webviewId" + t) : g(e, t, n);
        else if ("navigateBack" === o) if (s && y(s), p.hasOwnProperty(t)) {
            var r = p[t].page;
            s = {
                webviewId: t,
                route: e,
        ...
        else if ("switchTab" === o) if (s && v(s), p.hasOwnProperty(t)) {
            var i = p[t].page;
            s = {
                webviewId: t,
                route: e,
    ...
    m = function(e, t, n) {
        ...
        var o = p[e],
        i = o.page;
        if (t === c.DOM_READY_EVENT) return d.pageReadyTime = Date.now(),
        i.onReady(),
        void h("newPage2pageReady", d.newPageTime, d.pageReadyTime);
    ...
    _ = function(e, t) {
        ...
        o = p[t],
        r = o.page;
        if (r.hasOwnProperty("onMenuShareAppMessage")) { (0, u.info)("Invoke event onMenuShareAppMessage in page: " + o.route);
            var i = r.onMenuShareAppMessage() || {};
            n.title = i.title || e.title,
            n.desc = i.desc || e.desc,
            n.imgUrl = i.imgUrl || e.imgUrl,
            n.path = i.path ? (0, u.addHtmlSuffixToUrl)(i.path) : e.path,
    ...
    k = function(e, t) {
        ...
        o = p[t],
        r = o.page;
        if (r.hasOwnProperty("onMenuShareTimeline")) { (0, u.info)("Invoke event onMenuShareTimeline in page: " + o.route);
    ...
    WeixinJSBridge.subscribe("pageReady", (0, u.surroundByTryCatch)(function(e, t) {
        ...
        var n = p[t].page,
        o = {}; (0, u.info)("Update view with init data"),
        o.webviewId = t,
        __wxConfig && __wxConfig.downloadDomain && (o.downloadDomain = __wxConfig.downloadDomain),
        (0, u.publish)("pageInitData", {
            data: {
                data: n.data,
                ext: o,
                options: {
        ...
        (0, u.isEmptyObject)(n.__waitingData__) || ((0, u.info)("Update view with waiting data"), (0, u.info)(n.__waitingData__), (0, u.publish)("appDataChange", {
            data: {
        ...
        [t]), n.__waitingData__ = {}),
        (0, u.isEmptyObject)(n.__waitingAction__) || ((0, u.info)("Update view with waiting action"), (0, u.info)(n.__waitingAction__), (0, u.publish)("appDataChange", {
            data: {
...
function(e, t) {
    ...
    t.error = function(e, t) {
        console.group("%c" + e, "color: red; font-size: x-large"),
        console.error("%c" + t, "color: red; font-size: x-large"),
        console.groupEnd()
    },
    t.warn = function(e) {
...
function(e, t, n) {
    ...
    h = function() {
        ...
        return i(e, [{
            key: "update",
            value: function() { (0, a.warn)("Page.update is deprecated, setData updates the view implicitly")
            }
        },
        {
            key: "forceUpdate",
            value: function() { (0, a.warn)("Page.forceUpdate is deprecated, setData updates the view implicitly")
            }
        },
        {
            key: "setData",
            value: function(e) {
                try {
                    ...
                    this.__webviewReady__ ? s.
                default.emit(e, "data", this.__wxWebviewId__) : (0, a.extend)(this.__waitingData__, e)
        ...
        },
        {
            ...
            value: function(e) {
                try {
                    this.__webviewReady__ ? s.
                default.emit(e, "action", this.__wxWebviewId__) : (0, a.extend)(this.__waitingAction__, e)
                } catch(e) { (0, a.errorReport)(e)
                }
            }
        }]),
...
function(e, t, n) {
    ...
    t.getObjectByPath = function(e, t) {
        for (var n = r(t), i = void 0, a = void 0, u = e, c = 0; c < n.length; c++) Number(n[c]) === n[c] && n[c] % 1 === 0 ? Array.isArray(u) || (i[a] = [], u = i[a]) : (0, o.isPlainObject)(u) || (i[a] = {},
        u = i[a]),
        a = n[c],
        i = u,
        u = u[n[c]];
...
function(e, t, n) {
    ...
    a = function() {
        ...
        return r(e, null, [{
            key: "emit",
            value: function(e, t, n) { (0, i.info)("Update view with"),
                (0, i.info)(e),
...
function(e, t, n) {
    ...
    f = function() {
        function e(t) {
            ...
            WeixinJSBridge.on("onAppEnterBackground", a.bind(this)),
            WeixinJSBridge.on("onAppEnterForeground", f.bind(this))
        }
        return r(e, [{
            key: "getCurrentPage",
            value: function() {
